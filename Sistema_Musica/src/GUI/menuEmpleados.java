...
public class menuEmpleados extends JFrame implements InterfaceProgram {
	 ...
	 */
			...
			public void run() {
				try {
					menuEmpleados frame = new menuEmpleados();
	...
	public menuEmpleados() {
		...
		JButton Agregar = new JButton("Nuevo Empleado");
		...
		JButton Lista = new JButton("Lista Empleados");
