...
public class menuClientes extends JFrame implements InterfaceProgram {
	...
	public menuClientes() {
		...
		JButton Agregar = new JButton("Nuevo Cliente");
		...
		JButton Lista = new JButton("Lista Cliente");
