...
public class _BuscarEmpleado extends JFrame implements InterfaceProgram{
	 ...
	 */
			...
			public void run() {
				try {
					_BuscarEmpleado frame = new _BuscarEmpleado();
	...
	public _BuscarEmpleado() {
		...
		Buscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Empleado empleado = new Empleado().searchEmployer(ciBuscado);
				
				nombre.setText(empleado.getName());
				correo.setText(empleado.getCorreo());
				celular.setText(empleado.getCel());
				Date fechaDi = empleado.getRegistration();
				System.out.println(fechaDi);
				String fechaString=fechaDi.toString(); 
				fecha.setText(fechaString);
				edad.setText(Integer.toString(empleado.getEdad()));
				salario.setText(Double.toString(empleado.getSalary()));
		...
		lblEdad.setBounds(10, 456, 93, 50);
		contentPane.add(lblEdad);
		
		edad = new JTextField();
		edad.setFont(new Font("Microsoft YaHei UI Light", Font.PLAIN, 20));
		edad.setEditable(false);
		edad.setColumns(10);
		edad.setBounds(100, 459, 93, 50);
		contentPane.add(edad);
		
		JLabel lblSalario = new JLabel("Salario :");
		lblSalario.setFont(new Font("Microsoft YaHei UI Light", Font.PLAIN, 20));
		lblSalario.setBounds(228, 456, 93, 50);
		...
		salario.setBounds(359, 459, 116, 50);
